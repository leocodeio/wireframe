    ...
    <div className="flex flex-col items-center w-full min-h-screen">
      <div className="w-full max-w-lg md:max-w-4xl relative flex flex-col min-h-screen shadow-2xl bg-surface text-on-surface font-body antialiased relative overflow-x-hidden selection:bg-primary-container selection:text-on-primary-container pb-40" style={{ minHeight: 'max(884px, 100dvh)' }}>
        ...
        <header className="bg-[#FCF9F5] docked full-width top-0 flex items-center justify-between px-6 py-4 w-full no-border tonal-shift-bg-surface-container-low flat no shadows sticky z-40">
          <Link href="/stay/detail" aria-label="Back" className="text-[#1D9E75] hover:opacity-80 transition-opacity active:scale-95 duration-200 flex items-center justify-center p-2 -ml-2 rounded-full">
            <span className="material-symbols-outlined">arrow_back</span>
          </Link>
          <h1 className="font-['Inter'] font-semibold text-xl tracking-tight text-[#1A1A18]">Stay Summary</h1>
          {/* Invisible Spacer */}
        ...
        <main className="px-6 pt-8 pb-48 flex flex-col gap-10">
          ...
          <section className="flex flex-col gap-2 relative">
            ...
            <p className="text-[1.125rem] font-semibold text-on-surface-variant font-headline mt-2">Check-in complete</p>
          </section>
            ...
            <div className="relative z-10 flex flex-col items-center gap-6 w-full">
              ...
              <div className="flex flex-row flex-wrap gap-4 w-full justify-center">
                <div className="bg-surface rounded-full px-5 py-2.5 flex items-center gap-2 shadow-[inset_0_0_0_1px_rgba(188,202,193,0.15)]">
                  <span className="material-symbols-outlined text-[20px] text-on-surface-variant">bed</span>
                  <span className="text-[0.875rem] font-medium tracking-[0.02em] text-on-surface font-label">1 night stay</span>
                </div>
                <div className="bg-surface rounded-full px-5 py-2.5 flex items-center gap-2 shadow-[inset_0_0_0_1px_rgba(188,202,193,0.15)]">
                  <span className="material-symbols-outlined text-[20px] text-on-surface-variant">payments</span>
                  <span className="text-[0.875rem] font-medium tracking-[0.02em] text-on-surface font-label">₹850 paid</span>
                </div>
                <div className="bg-surface rounded-full px-5 py-2.5 flex items-center gap-2 shadow-[inset_0_0_0_1px_rgba(188,202,193,0.15)]">
                  <span className="material-symbols-outlined text-[20px] text-on-surface-variant">health_and_safety</span>
                  <span className="text-[0.875rem] font-medium tracking-[0.02em] text-on-surface font-label">Safety: 87/100</span>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="flex flex-col gap-8 bg-surface-container-low rounded-DEFAULT p-6 shadow-[inset_0_0_0_1px_rgba(188,202,193,0.1)]">
            <h3 className="text-[1.5rem] font-semibold tracking-[-0.01em] text-on-surface font-headline">Rate your stay</h3>
            ...
            <div className="flex flex-col gap-4">
              <label className="text-[0.875rem] font-medium tracking-[0.02em] text-on-surface-variant font-label">How did the stay feel?</label>
